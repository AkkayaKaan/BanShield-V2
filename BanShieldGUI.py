...
# raise Exception("CRASH TEST") #Testing for auto restart. This line lets me crash the banchecker manually. Enabling this will cause BanChecker will crash instantly.
